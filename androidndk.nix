...
stdenv.mkDerivation rec {
  ...
  src = if stdenv.system == "i686-linux"
    then fetchurl {
      ...
      sha256 = "0yy1k2ibxg9gcq56ys8mmpdi8k69x3zv8jxk6bjq3p4l2997j022";
    }
  ...
  in ''
    ...
    echo Generating "${bin_path}/android-ndk-path"
    
    echo "echo $out" > "${bin_path}/android-ndk-path"
    chmod a+x "${bin_path}/android-ndk-path"
    wrapProgram "${bin_path}/android-ndk-path"
  '';
